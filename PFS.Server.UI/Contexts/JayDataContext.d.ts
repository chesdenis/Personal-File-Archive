...
declare module PFS.Server.Core.Entities {
    ...
    export class IOPfsEntity extends $data.Entity {
        constructor();
        constructor(initData: { Path?: Edm.String; Name?: Edm.String });

        Path: Edm.String;
        Name: Edm.String;
    }

    export class Job extends $data.Entity {
        constructor();
        constructor(initData: { Id?: Edm.Int32; Name?: Edm.String; Args?: Edm.String; Comments?: Edm.String; Status?: PFS.Server.Core.Entities.JobStatus; Started?: Edm.DateTimeOffset; Finished?: Edm.DateTimeOffset; PlannedActionsCount?: Edm.Int32; CompletedActionsCount?: Edm.Int32 });

        Id: Edm.Int32;
        Name: Edm.String;
        Args: Edm.String;
        Comments: Edm.String;
        Status: PFS.Server.Core.Entities.JobStatus;
        Started: Edm.DateTimeOffset;
        Finished: Edm.DateTimeOffset;
        PlannedActionsCount: Edm.Int32;
        CompletedActionsCount: Edm.Int32;
    }

    export class ContentSource extends $data.Entity {
        constructor();
        constructor(initData: { Id?: Edm.Int32; Name?: Edm.String; DriveName?: Edm.String; Path?: Edm.String });

        Id: Edm.Int32;
        Name: Edm.String;
        DriveName: Edm.String;
        Path: Edm.String;
    }

    export class Video extends $data.Entity {
        constructor();
        constructor(initData: { Id?: Edm.Int32; Name?: Edm.String; Data?: Edm.String });
    ...
    export class Tag extends $data.Entity {
        constructor();
        constructor(initData: { Id?: Edm.Int32; Name?: Edm.String; MainParentId?: Edm.Int32; SecondaryParentId?: Edm.Int32 });

        Id: Edm.Int32;
        Name: Edm.String;
        MainParentId: Edm.Int32;
        SecondaryParentId: Edm.Int32;
    }

    export class PfsFile extends $data.Entity {
        constructor();
        constructor(initData: { Name?: Edm.String; Path?: Edm.String });

        Name: Edm.String;
        Path: Edm.String;
    }

    export class PfsFolder extends $data.Entity {
        constructor();
        constructor(initData: { Name?: Edm.String; Path?: Edm.String });
    ...
    export class PfsDrive extends $data.Entity {
        constructor();
        constructor(initData: { Name?: Edm.String; Path?: Edm.String });
...
declare module System.Linq {
    ...
    export class IQueryable_1OfPfsFile extends $data.Entity {
        constructor();
        constructor(initData: {  });

    }

    export class IQueryable_1OfPfsFolder extends $data.Entity {
        constructor();
        constructor(initData: {  });

    }

    export class IQueryable_1OfPfsDrive extends $data.Entity {
        constructor();
        constructor(initData: {  });
...
declare module Default {
    ...
    export class Container extends $data.EntityContext {
        ...
        Tags: $data.EntitySet<typeof PFS.Server.Core.Entities.Tag, PFS.Server.Core.Entities.Tag>;
        Videos: $data.EntitySet<typeof PFS.Server.Core.Entities.Video, PFS.Server.Core.Entities.Video>;
        ContentSources: $data.EntitySet<typeof PFS.Server.Core.Entities.ContentSource, PFS.Server.Core.Entities.ContentSource>;
        Jobs: $data.EntitySet<typeof PFS.Server.Core.Entities.Job, PFS.Server.Core.Entities.Job>;
        IOEntities: $data.EntitySet<typeof PFS.Server.Core.Entities.IOPfsEntity, PFS.Server.Core.Entities.IOPfsEntity>;
    }
