...
declare module PFS.Server.Core.Entities {
    export class Tag extends $data.Entity {
        constructor();
        constructor(initData: { Id?: number; Name?: string; });
        Id: number;
        Name: string;
...
declare module Default {
    export class Container extends $data.EntityContext {
        onReady(): $data.IPromise<Container>;
        onReady(handler: (context: Container) => void): $data.IPromise<Container>;

        Tags: $data.EntitySet<PFS.Server.Core.Entities.Tag>;
